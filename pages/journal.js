    ...
    return (
        <Flex flexDir="column" maxW={800} align="center" justify="center" minH="100vh" m="auto" px={4}>
            <Flex justify="space-between" w="100%" align="center">
                <Heading mb={4}>Welcome, {AuthUser.displayName}!</Heading>
                <Flex>
                    <DarkModeSwitch />
            ...
            <InputGroup>
                ...
                />
                <Input id='emojiInput' type="text" onChange={(e) => setInput(e.target.value)} placeholder="Add emoji" />
                <Button
                    ml={2}
                    onClick={() => sendData()}
                >
                ...
                return (
                    <>
                        ...
                        >
                            ...
                            <IconButton onClick={() => deleteEmoji(t)} icon={<DeleteIcon />} />
                        </Flex>
                    </>
                )
            })}
